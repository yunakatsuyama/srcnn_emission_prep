...
train_cams_data = np.load("cams_conserv_xe_train.npy")
train_eagrid_data = np.load("eagrid_dataset_train.npy")
train_bilinear_data = np.load("cams_interp_xe_train.npy") # omly for comparizon 

test_cams_data = np.load("cams_conserv_xe_test.npy")
test_eagrid_data = np.load("eagrid_dataset_test.npy")
test_bilinear_data = np.load("cams_interp_xe_test.npy")
...
for test_batch_low, test_batch_high, batch_bili, idx_batch in test_loader:
    ...
    L_bili = criterion(batch_bili, test_batch_high)
...
np.save("result_h/SRCNN_output_test.npy", all_Z_test_sorted)
np.save("result_h/bilinear_test.npy", all_bilinear_sorted)
np.save("result_h/ground_truth_test.npy", eagrid_sorted)
np.save("result_h/input_cams_test.npy", cams_sorted)